     ...
     <Header />
      <div className=" w-10/12 md:py-[10vh] md:grid-cols-1 m-auto grid grid-cols-3 gap-4  hero mt-[10vh]">
            <div className="col1 flex flex-col justify-center items-start h-[90vh] md:h-[auto] md:my-[5vh]">
              <p className='text-[#405DF8]'><i className='bx bxs-rocket'></i> Fast Shipping all over kenya</p>
              <h1 className='font-bold text-6xl text-left font-serif'>Win with the best sports gear</h1>
              <p className='text-left text-xl opacity-50 my-5 text-'>We've tied up with the best sports brand all over kenya to give you high quality & premium sports gear</p>
               <Link to='/Signup'>
            ...
            <div className="col3 px-5 md:px-2  flex justify-center flex-col h-[90vh] md:h-[auto] md:my-[5vh]  items-start">
              ...
              <img src="https://img.freepik.com/free-vector/color-sport-sneaker_98292-3191.jpg?size=626&ext=jpg" alt="" className='w-[90px] h-[90px] rounded-full ' />
